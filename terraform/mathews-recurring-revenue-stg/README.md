...
1. Open a Cloud Shell on the created project to execute all of the commands below.
...
1. Create a Workload Identity Pool w/ the server name:
...
1. Create a Workload Identity Provider w/ the repository name:
...
1. Extract the Workload Identity Provider name:
...
1. Allow the Workload Identity Pool to impersonate the Service Account:
